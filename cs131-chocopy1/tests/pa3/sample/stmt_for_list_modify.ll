...
source_filename = "../tests/pa3/sample/stmt_for_list_modify.py"
...
label9:                                                ; preds = %label3
  %op10 = getelementptr [3 x i32], [3 x i32]* @z, i32 0, i32 %op7
  store i32 %op8, i32* %op10
  %op11 = call %$int$prototype_type* @makeint(i32 %op8)
