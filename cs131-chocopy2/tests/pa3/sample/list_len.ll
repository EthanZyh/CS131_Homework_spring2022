...
source_filename = "../tests/pa3/sample/list_len.py"
...
label0:
  ...
  %op2 = load [3 x i32], [3 x i32]*@x
  %op3 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 0
  %op4 = bitcast i32* %op3 to %$union.conslist*
  %op5 = load %$union.conslist, %$union.conslist* %op4
  %op6 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 1
  %op7 = bitcast i32* %op6 to %$union.conslist*
  %op8 = load %$union.conslist, %$union.conslist* %op7
  %op9 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 2
  %op10 = bitcast i32* %op9 to %$union.conslist*
  %op11 = load %$union.conslist, %$union.conslist* %op10
  %op12 = call %$.list$prototype_type* @conslist(3, %$union.conslist %op5, %$union.conslist %op8, %$union.conslist %op11)
  %op13 = bitcast %$.list$prototype_type* %op12 to %$union.len*
