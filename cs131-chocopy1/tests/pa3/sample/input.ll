...
source_filename = "../tests/pa3/sample/input.py"
...
label0:
  ...
  %op4 = load %$str$prototype_type, %$str$prototype_type* %op3
  store %$str$prototype_type %op4, %$str$prototype_type* @const_9
  br label %label5

label5:                                                ; preds = %label0, %label9
  %op6 = bitcast %$str$prototype_type* @const_9 to %$union.len*
  %op7 = call i32 @$len(%$union.len* %op6)
  %op8 = icmp sgt i32 %op7, 0
  br  i1 %op8, label %label9, label %label14

label9:                                                ; preds = %label5
  %op10 = bitcast %$str$prototype_type* @const_9 to %$union.put*
  call void @print(%$union.put* %op10)
  %op11 = load %$str$prototype_type, %$str$prototype_type* @const_9
  %op12 = call %$str$prototype_type* @$input()
  %op13 = load %$str$prototype_type, %$str$prototype_type* %op12
  store %$str$prototype_type %op13, %$str$prototype_type* @const_9
  br label %label5
