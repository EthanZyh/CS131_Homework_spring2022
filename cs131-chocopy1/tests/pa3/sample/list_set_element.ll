...
source_filename = "../tests/pa3/sample/list_set_element.py"
...
label0:
  ...
  %op2 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, [3 x i32] @x
  store i32 4, i32* %op2
  %op3 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 4
  store i32 5, %$union.conslist** %op3
  %op4 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 5
  store i32 6, i32* %op4
  call void @error.OOB()
  %op5 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 0
  ...
  %op9 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 1
  ...
  %op13 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 2
