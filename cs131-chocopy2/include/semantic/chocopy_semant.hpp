...
public:
    ...
    */
    ...
    bool CouldBeAssign(SymbolType* T_2, SymbolType* T_1);
    bool IsInherit(string a, string b);
    map<string, vector<string>> childs;
    map<string, string> father;
    bool le(string a, string b);
    SymbolType* LCA(SymbolType* a, SymbolType* b);
...
public:
    ...
    void visit(parser::ForStmt &node) override;
    void visit(parser::ReturnStmt &node) override;
    void visit(parser::VarAssignStmt &node) override;
    void visit(parser::VarAssignExpr &node) override;
