...
source_filename = "../tests/pa3/sample/list_get_element_oob_2.py"
...
label0:
  ...
  call void @error.OOB()
  %op2 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 3
  %op3 = load i32, i32* %op2
  %op4 = call %$int$prototype_type* @makeint([3 x i32] %op3)
