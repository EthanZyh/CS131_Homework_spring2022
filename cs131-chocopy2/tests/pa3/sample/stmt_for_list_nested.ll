...
source_filename = "../tests/pa3/sample/stmt_for_list_nested.py"
...
label3:                                                ; preds = %label0, %label22
  %op4 = phi i32 [ %op2, %label0 ], [ %op7, %label22 ]
...
label12:                                                ; preds = %label9, %label18
  %op13 = phi i32 [ %op10, %label9 ], [ %op16, %label18 ]
  %op14 = icmp ne i32 2, %op13
  %op15 = getelementptr [3 x i32], [3 x i32]* @z, i32 0, i32 %op13
  %op16 = add i32 %op13, 1
  %op17 = load i32, i32* %op15
  br label %label18

label18:                                                ; preds = %label12
  %op19 = mul i32 %op8, %op17
