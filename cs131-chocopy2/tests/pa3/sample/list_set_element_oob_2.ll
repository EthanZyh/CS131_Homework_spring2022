...
source_filename = "../tests/pa3/sample/list_set_element_oob_2.py"
...
label0:
  ...
  %op7 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 1
  %op8 = load i32, i32* %op7
  %op9 = call %$int$prototype_type* @makeint(i32 %op8)
  %op10 = bitcast %$int$prototype_type* %op9 to %$union.put*
  call void @print(%$union.put* %op10)
  %op11 = getelementptr [3 x i32], [3 x i32]* @x, i32 0, i32 2
