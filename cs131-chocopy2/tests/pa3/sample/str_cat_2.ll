...
source_filename = "../tests/pa3/sample/str_cat_2.py"
...
@str.const_9 = private unnamed_addr constant [3 x i8] c"no\00", align 1
...
@str.const_10 = private unnamed_addr constant [2 x i8] c"o\00", align 1
...
@str.const_11 = private unnamed_addr constant [1 x i8] c"\00", align 1
...
@str.const_13 = private unnamed_addr constant [1 x i8] c"\00", align 1
...
label0:
  ...
  %op9 = bitcast %$str$prototype_type* @const_11 to %$union.put*
  call void @print(%$union.put* %op9)
  %op10 = bitcast %$str$prototype_type* @const_12 to %$union.put*
  call void @print(%$union.put* %op10)
  %op11 = bitcast %$str$prototype_type* @const_13 to %$union.put*
