...
source_filename = "../tests/pa3/sample/stmt_for_str_same_var.py"
...
@str.const_9 = private unnamed_addr constant [4 x i8] c"xXx\00", align 1
...
label0:
  ...
  %op2 = alloca i32
  store i32 0, i32* %op2
  %op3 = bitcast %$str$prototype_type* @const_9 to %$union.len*
...
label5:                                                ; preds = %label0, %label12
  ...
  %op8 = add i32 %op6, 1
  %op9 = getelementptr %$str$prototype_type, %$str$prototype_type* @const_9, i32 0, i32 4
...
label12:                                                ; preds = %label5
  ...
  br  i1 %op7, label %label5, label %label14

label14:                                                ; preds = %label12
  %op15 = bitcast %$str$prototype_type* @const_9 to %$union.put*
