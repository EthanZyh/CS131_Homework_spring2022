...
source_filename = "../tests/pa3/sample/stmt_for_str_nested.py"
...
label12:                                                ; preds = %label5
  ...
  %op15 = bitcast %$str$prototype_type* @const_10 to %$union.len*
...
label18:                                                ; preds = %label12, %label25
  ...
  %op21 = add i32 %op19, 1
  %op22 = getelementptr %$str$prototype_type, %$str$prototype_type* @const_10, i32 0, i32 4
