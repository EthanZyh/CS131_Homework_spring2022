...
source_filename = "../tests/pa3/sample/stmt_for_list_nested_same_var.py"
...
label3:                                                ; preds = %label0, %label20
  %op4 = phi i32 [ %op2, %label0 ], [ %op7, %label20 ]
...
label11:                                                ; preds = %label9, %label17
  %op12 = phi i32 [ %op8, %label9 ], [ %op15, %label17 ]
  %op13 = icmp ne i32 %op8, i32 %op12
  %op14 = getelementptr [3 x i32], [3 x i32]* @z, i32 0, i32 %op12
  %op15 = add i32 %op12, 1
  %op16 = load i32, i32* %op14
  br label %label17

label17:                                                ; preds = %label11
  %op18 = call %$int$prototype_type* @makeint(i32 %op16)
  %op19 = bitcast %$int$prototype_type* %op18 to %$union.put*
  call void @print(%$union.put* %op19)
  br  i1 %op13, label %label11, label %label20

label20:                                                ; preds = %label17
  br  i1 %op5, label %label3, label %label10
}
