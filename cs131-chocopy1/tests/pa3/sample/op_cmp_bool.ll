...
source_filename = "../tests/pa3/sample/op_cmp_bool.py"
...
label0:
  ...
  %op2 = zext i1 1 to i32
  %op3 = zext i1 1 to i32
  ...
  %op7 = zext i1 1 to i32
  %op8 = zext i1 0 to i32
  ...
  %op12 = zext i1 0 to i32
  %op13 = zext i1 1 to i32
  ...
  %op17 = zext i1 0 to i32
  %op18 = zext i1 0 to i32
  ...
  %op22 = zext i1 1 to i32
  %op23 = zext i1 1 to i32
  %op24 = icmp ne i32 %op22, %op23
  ...
  %op27 = zext i1 1 to i32
  %op28 = zext i1 0 to i32
  %op29 = icmp ne i32 %op27, %op28
  ...
  %op32 = zext i1 0 to i32
  %op33 = zext i1 1 to i32
  %op34 = icmp ne i32 %op32, %op33
  ...
  %op37 = zext i1 0 to i32
  %op38 = zext i1 0 to i32
