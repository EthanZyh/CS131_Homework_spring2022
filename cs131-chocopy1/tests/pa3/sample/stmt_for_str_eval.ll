...
source_filename = "../tests/pa3/sample/stmt_for_str_eval.py"
...
@str.const_10 = private unnamed_addr constant [4 x i8] c"abc\00", align 1
...
@str.const_11 = private unnamed_addr constant [15 x i8] c"doesn't matter\00", align 1
...
label0:
  ...
  %op2 = alloca i32
  store i32 0, i32* %op2
  %op3 = bitcast %$str$prototype_type* @const_10 to %$union.len*
  %op4 = call i32 @$len(%$union.len* %op3)
  br label %label5

label5:                                                ; preds = %label0, %label12
  %op6 = phi i32 [ %op4, %label0 ], [ %op8, %label12 ]
  %op7 = icmp ne i32 %op4, %op6
  %op8 = add i32 %op6, 1
  %op9 = getelementptr %$str$prototype_type, %$str$prototype_type* @const_10, i32 0, i32 4
  %op10 = load %$union.conslist*, %$union.conslist** %op9
  %op11 = call %$str$dispatchTable_type* @initchars(i8* %op10)
  br label %label12

label12:                                                ; preds = %label5
  %op13 = load %$str$prototype_type, %$str$prototype_type* @const_10
  %op14 = bitcast %$str$dispatchTable_type* %op11 to %$union.put*
