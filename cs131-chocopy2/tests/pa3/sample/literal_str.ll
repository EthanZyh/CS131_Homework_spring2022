...
source_filename = "../tests/pa3/sample/literal_str.py"
...
@const_9 = global %$str$prototype_type {
  ...
  %$str$dispatchTable_type* @$str$dispatchTable,
  i32 11,
  i8* getelementptr inbounds ([12 x i8], [12 x i8]* @str.const_9, i32 0, i32 0) 
}
@str.const_9 = private unnamed_addr constant [12 x i8] c"Hello World\00", align 1
